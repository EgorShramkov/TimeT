...
options = json.load(open(' TimeT/timeT/options.json', 'r'))
subjects = json.load(open(' TimeT/timeT/subjects.json', 'r'))
...
class PageHandler(tornado.web.RequestHandler):                   
     def post(self): 
        ...
        defaults = json.load(open(' TimeT/timeT/defaults.json', 'r'))
        template = {
            'days':days,
            'day': day,
            'subjects': subjects,
